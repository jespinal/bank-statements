...
LAST_FOUR=${CREDITCARD_ID: -4}

# There's really no reason to modify these lines unless you know exactly what
# you are doing
TRANSACTIONS_DUMP="./reports/transactions-${LAST_FOUR}__${FROM_DATE}-to-${TO_DATE}_${UNIQUE_ID}.json"
DOP_REPORT="./reports/transactions-DOP-${LAST_FOUR}-report__${FROM_DATE}-to-${TO_DATE}_${UNIQUE_ID}.csv"
USD_REPORT="./reports/transactions-USD-${LAST_FOUR}-report__${FROM_DATE}-to-${TO_DATE}_${UNIQUE_ID}.csv"
